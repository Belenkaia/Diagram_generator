 ...
 */
package ru.iaie.reflex.diagram.ide.contentassist.antlr;
...
import ru.iaie.reflex.diagram.ide.contentassist.antlr.internal.InternalReflexParser;
...
public class ReflexParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ReflexGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBodyAccess().getLoopAssignment_4(), "rule__Body__LoopAssignment_4");
			builder.put(grammarAccess.getBodyAccess().getRestartAssignment_5(), "rule__Body__RestartAssignment_5");
			builder.put(grammarAccess.getBodyAccess().getStatementsAssignment_6(), "rule__Body__StatementsAssignment_6");
			builder.put(grammarAccess.getBodyAccess().getStatementsAssignment_7_2(), "rule__Body__StatementsAssignment_7_2");
