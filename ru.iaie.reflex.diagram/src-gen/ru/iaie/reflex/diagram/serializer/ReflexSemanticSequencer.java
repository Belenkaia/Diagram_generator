...
public class ReflexSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == ReflexPackage.eINSTANCE)
			...
			case ReflexPackage.ENUM:
				sequence_Enum(context, (ru.iaie.reflex.diagram.reflex.Enum) semanticObject); 
				return; 
			...
			case ReflexPackage.PROCESS:
				sequence_Process(context, (ru.iaie.reflex.diagram.reflex.Process) semanticObject); 
				return; 
	 ...
	 */
	protected void sequence_Process(ISerializationContext context, ru.iaie.reflex.diagram.reflex.Process semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
