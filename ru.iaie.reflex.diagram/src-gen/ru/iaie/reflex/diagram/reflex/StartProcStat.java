 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflex.diagram.reflex.StartProcStat#getProcId <em>Proc Id</em>}</li>
 * </ul>
 *
 * @see ru.iaie.reflex.diagram.reflex.ReflexPackage#getStartProcStat()
 * @model
 * @generated
 */
public interface StartProcStat extends Statement
{
   ...
   * @see ru.iaie.reflex.diagram.reflex.ReflexPackage#getStartProcStat_ProcId()
   * @model
   * @generated
   */
  String getProcId();
  ...
  /**
   * Sets the value of the '{@link ru.iaie.reflex.diagram.reflex.StartProcStat#getProcId <em>Proc Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
