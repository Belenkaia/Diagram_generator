 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflex.diagram.reflex.ImportedVariable#getProcId <em>Proc Id</em>}</li>
 *   <li>{@link ru.iaie.reflex.diagram.reflex.ImportedVariable#getVarNames <em>Var Names</em>}</li>
 * </ul>
 *
 * @see ru.iaie.reflex.diagram.reflex.ReflexPackage#getImportedVariable()
 * @model
 * @generated
 */
public interface ImportedVariable extends Variable
{
   ...
   * @see ru.iaie.reflex.diagram.reflex.ReflexPackage#getImportedVariable_ProcId()
   * @model
   * @generated
   */
  String getProcId();
  ...
  /**
   * Sets the value of the '{@link ru.iaie.reflex.diagram.reflex.ImportedVariable#getProcId <em>Proc Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see ru.iaie.reflex.diagram.reflex.ReflexPackage#getImportedVariable_VarNames()
   * @model unique="false"
   * @generated
   */
