 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflex.diagram.reflex.StopProcStat#getProcId <em>Proc Id</em>}</li>
 * </ul>
 *
 * @see ru.iaie.reflex.diagram.reflex.ReflexPackage#getStopProcStat()
 * @model
 * @generated
 */
public interface StopProcStat extends Statement
{
   ...
   * @see ru.iaie.reflex.diagram.reflex.ReflexPackage#getStopProcStat_ProcId()
   * @model
   * @generated
   */
  String getProcId();
  ...
  /**
   * Sets the value of the '{@link ru.iaie.reflex.diagram.reflex.StopProcStat#getProcId <em>Proc Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
