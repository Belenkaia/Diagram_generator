...
public interface RegisterPort extends EObject
{
   ...
   * @see #setPort(ru.iaie.reflex.diagram.reflex.Integer)
   * @see ru.iaie.reflex.diagram.reflex.ReflexPackage#getRegisterPort_Port()
   * @model containment="true"
   * @generated
   */
  ru.iaie.reflex.diagram.reflex.Integer getPort();

  /**
   * Sets the value of the '{@link ru.iaie.reflex.diagram.reflex.RegisterPort#getPort <em>Port</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setPort(ru.iaie.reflex.diagram.reflex.Integer value);
