...
public class ReflexPackageImpl extends EPackageImpl implements ReflexPackage
{
   ...
   * @see ru.iaie.reflex.diagram.reflex.ReflexPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   */
  @Override
  public EAttribute getRegisterPort_Port()
  {
    return (EAttribute)registerPortEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(registerPortEClass, REGISTER_PORT__PORT);
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(processEClass, ru.iaie.reflex.diagram.reflex.Process.class, "Process", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getProcess_Name(), ecorePackage.getEString(), "name", null, 0, 1, ru.iaie.reflex.diagram.reflex.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getProcess_Variable(), this.getVariable(), null, "variable", null, 0, -1, ru.iaie.reflex.diagram.reflex.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getProcess_States(), this.getState(), null, "states", null, 0, -1, ru.iaie.reflex.diagram.reflex.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getRegisterPort_Port(), ecorePackage.getEString(), "port", null, 0, 1, RegisterPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
