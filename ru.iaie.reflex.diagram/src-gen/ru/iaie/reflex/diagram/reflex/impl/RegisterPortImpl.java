...
public class RegisterPortImpl extends MinimalEObjectImpl.Container implements RegisterPort
{
   ...
   * @ordered
   */
  protected ru.iaie.reflex.diagram.reflex.Integer port;
   ...
   */
  @Override
  public ru.iaie.reflex.diagram.reflex.Integer getPort()
  {
    return port;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetPort(ru.iaie.reflex.diagram.reflex.Integer newPort, NotificationChain msgs)
  {
    ru.iaie.reflex.diagram.reflex.Integer oldPort = port;
    port = newPort;
    if (eNotificationRequired())
    {
   ...
   */
  @Override
  public void setPort(ru.iaie.reflex.diagram.reflex.Integer newPort)
  {
    if (newPort != port)
    {
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case ReflexPackage.REGISTER_PORT__REG_NAME:
        ...
        return;
      case ReflexPackage.REGISTER_PORT__PORT:
        setPort((ru.iaie.reflex.diagram.reflex.Integer)newValue);
        return;
    }
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      case ReflexPackage.REGISTER_PORT__REG_NAME:
        ...
        return;
      case ReflexPackage.REGISTER_PORT__PORT:
        setPort((ru.iaie.reflex.diagram.reflex.Integer)null);
        return;
    }
