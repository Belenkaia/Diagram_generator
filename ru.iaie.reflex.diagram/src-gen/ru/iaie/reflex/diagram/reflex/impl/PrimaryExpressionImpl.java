 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflex.diagram.reflex.impl.PrimaryExpressionImpl#getVarId <em>Var Id</em>}</li>
 *   <li>{@link ru.iaie.reflex.diagram.reflex.impl.PrimaryExpressionImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimaryExpressionImpl extends UnaryExpressionImpl implements PrimaryExpression
{
   ...
   * @ordered
   */
  protected ru.iaie.reflex.diagram.reflex.Integer literal;
   ...
   */
  @Override
  public ru.iaie.reflex.diagram.reflex.Integer getLiteral()
  {
    return literal;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetLiteral(ru.iaie.reflex.diagram.reflex.Integer newLiteral, NotificationChain msgs)
  {
    ru.iaie.reflex.diagram.reflex.Integer oldLiteral = literal;
    literal = newLiteral;
    if (eNotificationRequired())
    {
   ...
   */
  @Override
  public void setLiteral(ru.iaie.reflex.diagram.reflex.Integer newLiteral)
  {
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case ReflexPackage.PRIMARY_EXPRESSION__VAR_ID:
        ...
        return;
      case ReflexPackage.PRIMARY_EXPRESSION__LITERAL:
        setLiteral((ru.iaie.reflex.diagram.reflex.Integer)newValue);
        return;
    }
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      case ReflexPackage.PRIMARY_EXPRESSION__VAR_ID:
        ...
        return;
      case ReflexPackage.PRIMARY_EXPRESSION__LITERAL:
        setLiteral((ru.iaie.reflex.diagram.reflex.Integer)null);
        return;
    }
