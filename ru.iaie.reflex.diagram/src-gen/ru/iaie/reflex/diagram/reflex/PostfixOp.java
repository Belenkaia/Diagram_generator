 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflex.diagram.reflex.PostfixOp#getVarId <em>Var Id</em>}</li>
 *   <li>{@link ru.iaie.reflex.diagram.reflex.PostfixOp#getOp <em>Op</em>}</li>
 * </ul>
 *
 * @see ru.iaie.reflex.diagram.reflex.ReflexPackage#getPostfixOp()
 * @model
 * @generated
 */
public interface PostfixOp extends UnaryExpression
{
   ...
   * @see #setVarId(String)
   * @see ru.iaie.reflex.diagram.reflex.ReflexPackage#getPostfixOp_VarId()
   * @model
   * @generated
   */
  String getVarId();
  ...
  /**
   * Sets the value of the '{@link ru.iaie.reflex.diagram.reflex.PostfixOp#getVarId <em>Var Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see ru.iaie.reflex.diagram.reflex.ReflexPackage#getPostfixOp_Op()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link ru.iaie.reflex.diagram.reflex.PostfixOp#getOp <em>Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
