...
public interface PrimaryExpression extends UnaryExpression
{
   ...
   * @see #setVarId(String)
   * @see ru.iaie.reflex.diagram.reflex.ReflexPackage#getPrimaryExpression_VarId()
   * @model
   * @generated
   */
  String getVarId();
  ...
  /**
   * Sets the value of the '{@link ru.iaie.reflex.diagram.reflex.PrimaryExpression#getVarId <em>Var Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
