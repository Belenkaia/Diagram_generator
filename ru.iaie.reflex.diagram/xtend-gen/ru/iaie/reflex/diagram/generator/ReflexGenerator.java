...
public class ReflexGenerator extends AbstractGenerator {
  ...
  public String generateStatechartNodes(final Resource resource, final ru.iaie.reflex.diagram.reflex.Process process) {
    String tempString = "";
    String _tempString = tempString;
    CharSequence _generateOneProcessNode = this.generateOneProcessNode(this.count_id, "     ", "circle");
    tempString = (_tempString + _generateOneProcessNode);
    ...
    for (final State state : _states) {
      {
        ...
        CharSequence _generateOneProcessNode_1 = this.generateOneProcessNode(this.count_id, state.getName(), "roundrectangle");
    ...
    for (final DeclaredVariable variable : _filter) {
      {
        ...
        CharSequence _generateOneProcessNode = this.generateOneProcessNode(this.count_id, this.getVariableNameAndType(variable), "ellipse");
    ...
    for (final ru.iaie.reflex.diagram.reflex.Process process : _filter) {
      {
        ...
        fsa.generateFile(_plus, this.generateStatechartDiagram(resource, process));
        this.clear();
      }
    }
  }
